# Operator Quickstart — Manufacture of Engines and Turbines

Shortest path from clone to a verified local dry-run for **ISIC 2811** (`cloud-itonami-isic-2811`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2811.git
cd cloud-itonami-isic-2811
```
...
- Blueprint governor key: `turbine-governor`
- Likely source path: `turbine.governor.cljc`
