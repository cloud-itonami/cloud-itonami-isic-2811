(ns turbine.phase
  "Phase 0->3 staged rollout -- the turbine plant analog of
  ...
  milestone still to come. Dispatching a real robot unit action on
  a rotating-critical structure and issuing real class evidence
...
;; issue-type-evidence` are members of `write-ops` (governor-
...
(defn verdict->disposition
  "Map an Turbine Governor verdict to a base
